...
//extrae los datos del fomrualrio de registro de personas y elimina espaicosinnecesarios 
	...
	case 'listarp':
		$rspta=$persona->listarp();
 		...
 		while ($reg=$rspta->fetch_object()){
 			$data[]=array(
 				"0"=>'<button class="btn btn-warning" onclick="mostrar('.$reg->idpersona.')"><i class="fas fa-pencil-alt"></i></button>'.

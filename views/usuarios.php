									...
									<form name="formulario" id="formulario" method="POST">
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label>email</label>
													<input type="email" class="form-control" name="email" id="email" maxlength="20" placeholder="Teléfono">
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label>cargo</label>
													<input type="text" class="form-control" name="cargo" id="cargo" maxlength="20" placeholder="Teléfono">
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label>login</label>
													<input type="text" class="form-control" name="login" id="login" maxlength="20" placeholder="Teléfono">
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label>clave</label>
													<input type="password" class="form-control" name="clave" id="clave" maxlength="20" placeholder="Teléfono">
												</div>
											</div>
